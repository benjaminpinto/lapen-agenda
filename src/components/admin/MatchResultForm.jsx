...
const MatchResultForm = ({ match, onSubmit, onCancel }) => {
  ...
  const handleSubmit = () => {
    ...
    // Determine if third set is needed
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b">
                ...
                <th className="text-center p-2">Super Tiebreak</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b">
        ...
        <p className="text-xs text-gray-500">Super tiebreak é opcional (apenas se necessário)</p>
