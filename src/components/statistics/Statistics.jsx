...
import {calculateAdditionalStats} from '@/utils/statisticsUtils'
...
export default function Statistics() {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      const additionalStats = stats && !player2 ? calculateAdditionalStats(stats, player1) : null
    ...
    <div className="space-y-6" data-testid="statistics-page">
      ...
      {stats && (
        <>
          ...
          {(() => {
            const additionalStats = calculateAdditionalStats(stats, player1)
          ...
          <DialogContent className="max-w-[850px]">
            <div className="overflow-x-auto">
              <ShareableStatsCard
                ...
                additionalStats={stats && !player2 ? calculateAdditionalStats(stats, player1) : null}
              />
            </div>
