...
def get_user_by_id(user_id):
    ...
    db = get_db()
    try:
        cursor = db.execute('SELECT id, email, name, phone, is_verified, is_lapen_member, lapen_approved, lapen_requested_at, lapen_approved_at, is_admin FROM users WHERE id = ?', (user_id,))
